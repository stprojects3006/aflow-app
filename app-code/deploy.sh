...
# PetClinic Application Deployment Script
# This script builds, tests, and deploys the complete PetClinic application with monitoring stack
...
show_help() {
    ...
    echo "   • Application only: ./deploy-app.sh"
    echo "   • Infrastructure only: ./deploy-infra.sh"
